...
license-headers: FORCE prepare-addlicense
	...
	@addlicense -c "SAP SE" -ignore "vendor/**" -ignore "internal/acceptance/clients/http.go" -ignore "internal/acceptance/tools/tools.go" -- **/*.go

check-license-headers: FORCE prepare-addlicense
	@printf "\e[1;36m>> addlicense\e[0m\n"
	@bash -c 'shopt -s globstar; addlicense --check -ignore "vendor/**" -ignore "internal/acceptance/clients/http.go" -ignore "internal/acceptance/tools/tools.go" -- **/*.go'
