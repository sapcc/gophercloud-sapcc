...
// NewCastellumV1Client returns a *ServiceClient for making calls
// to the Castellum v1 API. An error will be returned if
// authentication or client creation was not possible.
func NewCastellumV1Client(ctx context.Context) (*gophercloud.ServiceClient, error) {
	...
	return cc_clients.NewCastellumV1(client, gophercloud.EndpointOpts{
